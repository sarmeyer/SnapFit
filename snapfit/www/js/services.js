app.factory('imageService', function($http){
    return {
        ...
        getTags: function(accessData){
            return $http.get('http://localhost:3000/image_processor/file:///var/mobile/Containers/Data/Applications/9267D6CE-985C-43D1-97CF-7B1CD519DD86/tmp/cdv_photo_002.jpg)
